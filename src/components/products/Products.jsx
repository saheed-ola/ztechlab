  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-center items-center gap-4 sml:gap-5 mt-4 sm:mt-5 mb-[150px] sml:mb-[200px] md:mb-[250px]">
        ...
        >
          <div className="relative w-full mx-auto">
            <div className="text-lg xs:text-xl sm:text-2xl leading-normal mb-3 sm:mb-4 text-blue-700 flex justify-center">
          ...
          <div className="grid sml:grid-cols-2 gap-x-6 md:gap-x-12 place-items-center">
            <article className="mt-4 sm:mt-6">
              <ul className="leading-[1.8] text-base xs:text-lg sm:text-lg list-disc marker:text-yellow-500 ps-4 text-black-950 space-y-2 sm:space-y-3">
                <li>
                  Show a portfolio of the IoT devices and software platforms
                  ZTech Labs has developed, designed to solve challenges in
                  industries like agriculture, healthcare, and manufacturing.
                </li>
                <li>
                  Include case studies or success stories on how these products
                  have transformed businesses or communities.
                </li>
              </ul>
            </article>
          </div>
          ...
          <div className="w-full shadow-lg sml:shadow-xl md:shadow-2xl text-black p-4 xs:p-6 sm:p-8 md:p-10 rounded-xl sml:rounded-2xl md:rounded-3xl border-[1px] sml:border-[2px] bg-[#9b9b9b] mt-6 sm:mt-8">
            <div className="relative mx-auto flex items-center justify-center">
              <div className="text-lg xs:text-xl sm:text-2xl leading-normal mb-3 sm:mb-4 text-blue-700">
            ...
            <div className="grid sml:grid-cols-2 gap-x-6 md:gap-x-12 place-items-center">
              <div className="mt-4 sm:mt-6">
                <ul className="leading-[1.8] text-base xs:text-lg sm:text-lg list-disc marker:text-yellow-500 ps-4 text-black-950 space-y-2 sm:space-y-3">
                  <li>
                    Provide consulting and implementation services to businesses
                    looking to adopt IoT solutions, from concept to deployment.
                  </li>
                </ul>
              </div>
            </div>
